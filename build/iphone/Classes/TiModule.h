...
/**
 The base class for all PicpoProject modules
 */
...
/**
 PicpoProject Platform calls this method on startup.
 */
-(void)startup;

/**
 PicpoProject Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 PicpoProject Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 PicpoProject Platform calls this method on resume.
 @param sender The sender of the event.
 */
