 ...
 * Copyright (c) 2009-2011 by PicpoProject, Inc. All Rights Reserved.
...
//@interface PicpoProjectObject : NSObject
//@end

@interface PicpoProjectObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[PicpoProjectObject class]])
		{
			for (NSString *key in [[(PicpoProjectObject*)o modules] allKeys])
			{
