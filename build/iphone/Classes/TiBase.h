...
// in simulator we redefine to format for PicpoProject Developer console
...
{\
	NSString * exceptionName = [@"org.picpoproject." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.picpoproject";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIPicpoProjectNativeItemNone = -1, 
	UIPicpoProjectNativeItemSpinner = -2,
	UIPicpoProjectNativeItemProgressBar = -3,
	
	UIPicpoProjectNativeItemSlider = -4,
	UIPicpoProjectNativeItemSwitch = -5,
	UIPicpoProjectNativeItemMultiButton = -6,
	UIPicpoProjectNativeItemSegmented = -7,
	
	UIPicpoProjectNativeItemTextView = -8,
	UIPicpoProjectNativeItemTextField = -9,
	UIPicpoProjectNativeItemSearchBar = -10,
	
	UIPicpoProjectNativeItemPicker = -11,
	UIPicpoProjectNativeItemDatePicker = -12,
	
	UIPicpoProjectNativeItemInfoLight = -13,
	UIPicpoProjectNativeItemInfoDark = -14,
	
	UIPicpoProjectNativeItemDisclosure = -15,
	
	UIPicpoProjectNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all PicpoProject instances of
