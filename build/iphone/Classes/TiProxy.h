...
//Rare exceptions to indicate a bug in the _picpoproject code (Eg, function that a subclass should have implemented)
...
/**
 The base class for PicpoProject proxies.
 */
