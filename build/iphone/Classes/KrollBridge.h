...
@interface PicpoProjectObject : KrollCoverageObject {
#else
@interface PicpoProjectObject : KrollObject {
#endif
@private
...
extern NSString * PicpoProject$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	PicpoProjectObject *_picpoproject;
	BOOL shutdown;
